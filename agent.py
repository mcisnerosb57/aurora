...
EXTRA_TOOLS: List[Dict[str, Any]] = [    # ✏️ Build 2, step 2.1: schemas for the tools you add
    {
        ...
        "description": (
            "Find the earliest date on or after a given travel date with an available seat "
            "between an origin and destination in the requested cabin. Use this when a "
            "customer asks when they can next travel, rather than for a list of flight options."
        ),
        "input_schema": {
            "type": "object",
            "properties": {
                "origin": {"type": "string", "description": "Three-letter origin airport code."},
                "dest": {"type": "string", "description": "Three-letter destination airport code."},
                "date": {"type": "string", "description": "Earliest travel date in YYYY-MM-DD format."},
                "cabin": {"type": "string", "description": "Cabin code, such as Y or J."},
            },
